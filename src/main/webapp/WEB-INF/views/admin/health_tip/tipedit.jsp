...
<body>
	...
	<div id="main_content">
		<div id="add_content">
			<div id="article_div">
				<span>标题</span> &nbsp;&nbsp; <input type="text" id="title" name="title" value="${edittipcontent.title}">

			</div>
			<div id="source_div">
				<span>来源</span> &nbsp;&nbsp; <input type="text" id="source" name="source" value="${edittipcontent.source}">
			</div>
			<div id="ueditor_div">
				<!-- 编辑器配置-->
